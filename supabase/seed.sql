...
BEGIN
    ...
    -- 4) Insert 5-8 demo hair styles with realistic defaults
    ...
    -- 5) Use ON CONFLICT DO NOTHING where applicable
    ON CONFLICT (tenant_id, name) DO NOTHING;
